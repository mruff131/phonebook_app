...
api = Blueprint('api',__name__, url_prefix='/api')     #api comes before every slug of information
...
def get_contact(current_user_token):
    ...
    contacts = Contact.query.filter_by(user_token = a_user).all()  #brings back all contacts in database
...
#Updating contacts
@api.route('/contacts/<id>', methods = ['POST', 'PUT'])   #<> anything inside braces is a variable, put = replace
@token_required
